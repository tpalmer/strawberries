...
describe StrawberriesController do
  fixtures :all
  render_views
  ...
  it "create action should redirect when model is valid" do
    ...
    post :create
    response.should redirect_to(strawberry_url(assigns[:strawberry]))
  end
  ...
  it "destroy action should destroy model and redirect to index action" do
    ...
    response.should redirect_to(strawberries_url)
    Strawberry.exists?(strawberry.id).should be_false
  end
end
